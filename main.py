"""
CryptoBrain — AI trading signals from on-chain + social sentiment fusion
...
log = logging.getLogger("cryptobrain")
...
class Router:
    """Cost- and latency-aware model router for CryptoBrain."""
...
if __name__ == "__main__":
    import argparse
    p = argparse.ArgumentParser(description="CryptoBrain: AI trading signals from on-chain + social sentiment fusion")
